					...
					<ul class="nav navbar-nav nav_1">
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								<li onclick="onclicktab('upload.jsp');">
									<a href="#" >Upload Document</a>
								</li>
								<li onclick="onclicktab('shareddocument.jsp');">
									<a href="#" data-toggle="tab">Shared Document</a>
								</li>
								<li onclick="onclicktab('planstudy.jsp');">
									<a href="#" data-toggle="tab">Plan Study</a>
								</li>
								<li onclick="onclicktab('process.jsp');">
									<a href="#" data-toggle="tab">Study Process</a>
								</li>
							</ul>
						</li>
						<li onclick="onclicktab('discussSaukhilogin.jsp');"><a href="#">Discuss</a></li>
					</ul>
					</div><!-- /.navbar-collapse -->
				</div>
			</nav>
